...
from 2019-2023. Darker points represent locations that fall within
...
## Load package and tables

Load the `tidyverse` package to help with data exploration. Load the
tables from the database and assign them each to an object.

```{r tidyverse_tables, message = FALSE}
library(tidyverse)
...
Begin visualizing trends seen in the camera trap data. To use the same color scheme shown, run `devtools::install_github("cdanielcadena/tanagR")` and load the package `tanagR`.
